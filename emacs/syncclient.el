...
;; Auto-sincronización al compilar en AUCTeX / LaTeX
(eval-after-load 'tex
  '(add-hook 'TeX-after-compilation-finished-functions
             (lambda (_file)
               (syncclient--request "/sync/force" "POST" '((pairId . "wbbgaigay")) nil)
               (message "⚡ Proyecto LaTeX sincronizado automáticamente con Google Drive."))))
